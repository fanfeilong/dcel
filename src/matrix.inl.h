...
*******************************************************************************/
#ifndef DCEL_MK_GEOMETRY_MATRIX_INLINE_H
#define DCEL_MK_GEOMETRY_MATRIX_INLINE_H
...
//
template<class _T, int _WIDTH, int _HEIGHT>
bool Matrix<_T, _WIDTH, _HEIGHT>::has_nan() const
{
#ifndef WIN32
	for (int i = 0; i < count(); ++i)
...
//
template<class _T, int _WIDTH, int _HEIGHT>
bool Matrix<_T, _WIDTH, _HEIGHT>::has_inf() const
{
#ifndef WIN32
	for (int i = 0; i < count(); ++i)
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT>& Matrix<_T, _WIDTH, _HEIGHT>::copy_row(int index, const Matrix<_T, _WIDTH, 1> &m)
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT>& Matrix<_T, _WIDTH, _HEIGHT>::copy_col(int index, const Matrix<_T, 1, _HEIGHT> &m)
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT+1> Matrix<_T, _WIDTH, _HEIGHT>::add_back_row(const Matrix<_T, _WIDTH, 1> &r ) const
{
	return add_row(_HEIGHT, r);
}

//------------------------------------------------------------------------------
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH+1, _HEIGHT> Matrix<_T, _WIDTH, _HEIGHT>::add_back_col(const Matrix<_T, 1, _HEIGHT> &c) const
{
	return add_col(_WIDTH, c);
}
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT+1> Matrix<_T, _WIDTH, _HEIGHT>::add_front_row(const Matrix<_T, _WIDTH, 1> &r ) const
{
	return add_row(0, r);
}
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH+1, _HEIGHT> Matrix<_T, _WIDTH, _HEIGHT>::add_front_col(const Matrix<_T, 1, _HEIGHT> &c) const
{
	return add_col(0, c);
}
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT+1> Matrix<_T, _WIDTH, _HEIGHT>::add_row(int index, const Matrix<_T, _WIDTH, 1> &r ) const
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH+1, _HEIGHT> Matrix<_T, _WIDTH, _HEIGHT>::add_col(int index, const Matrix<_T, 1, _HEIGHT> &c) const
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT-1> Matrix<_T, _WIDTH, _HEIGHT>::remove_back_row() const
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH-1, _HEIGHT> Matrix<_T, _WIDTH, _HEIGHT>::remove_back_col() const
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT-1> Matrix<_T, _WIDTH, _HEIGHT>::remove_front_row() const
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH-1, _HEIGHT> Matrix<_T, _WIDTH, _HEIGHT>::remove_front_col() const
{
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH, _HEIGHT-1> Matrix<_T, _WIDTH, _HEIGHT>::remove_row(int index ) const
{
	Matrix<_T, _WIDTH, _HEIGHT-1> m;
	int i = 0, ri = 0;
...
//
template<class _T, int _WIDTH, int _HEIGHT>
Matrix<_T, _WIDTH-1, _HEIGHT> Matrix<_T, _WIDTH, _HEIGHT>::remove_col(int index) const
{
	Matrix<_T, _WIDTH-1, _HEIGHT> m;
	int i = 0, ci = 0;
